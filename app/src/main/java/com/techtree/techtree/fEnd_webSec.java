...
public class fEnd_webSec extends AppCompatActivity {
    ...
    private static final String PROGRESS = "SEEKBAR6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fend_web_sec);

        webSec_textview = findViewById(R.id.webSecKnowledgeInt);
        webSec_seekbar = findViewById(R.id.webSec_knowledge);
