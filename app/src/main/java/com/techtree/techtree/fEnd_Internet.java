...
public class fEnd_Internet extends AppCompatActivity {
    ...
    private static final String PROGRESS = "SEEKBAR1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fend_internet);

        internet_textview = findViewById(R.id.internetKnowledgeInt);
        internet_seekbar = findViewById(R.id.internet_knowledge);
